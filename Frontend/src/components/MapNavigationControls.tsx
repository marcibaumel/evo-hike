        ...
        <div className="map-nav-controls">
            <div className="nav-controls-container">
                ...
                <Button
                    ...
                    icon={<MapPinIcon size={24} weight={selectionMode === 'start' ? 'fill' : 'regular'} />}
                    color="#5cb85c"
                ...
                <Button
                    ...
                    icon={<FlagIcon size={24} weight={selectionMode === 'end' ? 'fill' : 'regular'} />}
                    color="#d9534f"
                ...
                <Button
                    ...
                    icon={<MapPinPlusIcon size={24} weight={selectionMode === 'waypoint' ? 'fill' : 'regular'} />}
                    color="#FF9800"
