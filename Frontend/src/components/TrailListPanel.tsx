...
import { MdSearch, MdFilterList, MdAddLocation, MdOutlineStar } from 'react-icons/md';
        ...
        <div className="trail-list-panel">
            <h2 className="trail-list-header">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <MdSearch style={{ marginRight: '10px' }} /> {t('trailList.search_title')}
                </div>
                <div style={{ marginLeft: 'auto', display: 'flex', gap: '10px' }}>
                    <MdFilterList style={{ cursor: 'pointer' }} title={t('trailList.filter')} />
                    <MdAddLocation
            ...
            <div className="trail-list-cards">
                {filteredTrails.map((trail) => (
                    <div
                        ...
                        <div className="trail-list-card-header" title={t('trailList.difficulty_level')}>
